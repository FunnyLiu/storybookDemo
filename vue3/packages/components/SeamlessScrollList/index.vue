 ...
 * @FileName: index.vue
 * @Author: liufang
 * @Date: 2022-07-05 10:49:24
 * @LastEditors: liufang
 * @Date: 2022-07-05 10:49:24
 * @Description: 无缝滚动列表组件
-->
<template>
  <div ref="wrap">
    <div
 ...
 * @example
 * ```
 * <seamless-scroll-list :data="listData" :style="style.wrap">
 *    <ul class="item">
...
export default {
  ...
  props: {
     ...
     * 参数对象
     *
     * step 步长 数值越大速度滚动越快， 默认为1
     *
     * limitMoveNum 开启动画的最小数量， 默认为5
     *
     * hoverStop 鼠标hover后是否停止， 默认是true
     *
     * direction 方向，0 往下 1 往上 2 向左 3 向右， 默认是1
     */
    params: {
      type: Object,
      default: () => {
  ...
  computed: {
    ...
    options() {
      return Object.assign({}, this.defaultOption, this.params)
    },
    navigation() {
